        ...
        <div className='membership'>
            <div className='container'>
                <div className='m_title'>
                    ...
                    <p className='join_botton'>Powered by Augmind Labs</p>
                </div>
                ...
                {/* <div className='m_fag'>
                    <div className='m_fag_title'>FAG</div>
                    <div className='m_fag_row'>
                        <div className='m_fag_left'>Got a question that isn’t answered here? Join our Discord and ask our team or community of members.</div>
                        <div className='m_fag_right'>
                            <div className='m_fag1'>
                                <div id='fa0' className='m_question'>How to become a member?<i className='fa fa-caret-down'></i></div>
                                <p id='a0' className='m_answer'>You’re able to buy on secondary marketplaces, such as OpenSea.</p>
                            </div>
                            <div className='m_fag1'>
                                <div id='fa2' className='m_question'>How to become a member?<i className='fa fa-caret-down'></i></div>
                                <p id='a2' className='m_answer'>You’re able to buy on secondary marketplaces, such as OpenSea.</p>
                            </div>
                            <div className='m_fag1'>
                                <div id='fa3' className='m_question'>How to become a member?<i className='fa fa-caret-down'></i></div>
                                <p id='a3' className='m_answer'>You’re able to buy on secondary marketplaces, such as OpenSea.</p>
                            </div>
                            <div className='m_fag1'>
                                <div id='fa4' className='m_question'>How to become a member?<i className='fa fa-caret-down'></i></div>
                                <p id='a4' className='m_answer'>You’re able to buy on secondary marketplaces, such as OpenSea.</p>
                            </div>
                        </div>
                    </div>
                </div> */}
